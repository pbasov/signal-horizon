...
- [signal-horizon-setting.md](signal-horizon-setting.md) — **The Setting** v0.4 (SD-60). Scenery only: why anyone is at the Moon and Mars, and why information is precious. Zero authority over mechanics — delete it and every rule still stands. §10 ruled 2026-09-01.
- [signal-horizon-beats.md](signal-horizon-beats.md) — **The Beats** v0.2 DRAFT (SD-60). The narrative *content*: the cast, the four channels, the tender/Wire/Registry grammar, twenty-eight beats across four eras, and the unlicensed P-thread. Eras add no systems; the P-thread does.
