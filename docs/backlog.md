...
### EPIC — SD-56 · THE DEV CONSOLE (in-game cheats/debug tile) · ships the playtest accelerator

*Rationale + the eight decisions in `docs/decisions.md` SD-56. The whole epic is DEV-side: no sim
