...
/**
 * SD-56 — THE CHEAT ENGINE. The console's contract with the sim is exactly one round trip:
...
describe("SD-56 cheat engine — the wallet", () => {
...
describe("SD-56 cheat engine — SKIP ACTS (the headline verb)", () => {
...
describe("SD-56 cheat engine — the launch pipeline", () => {
...
describe("SD-56 cheat engine — faults", () => {
...
describe("SD-56 cheat engine — contracts", () => {
...
describe("SD-56 sandbox — the standing 'just let me look at it' mode", () => {
...
describe("SD-56 mission catalogue — derived from the beats, never hand-listed", () => {
...
describe("SD-56 cheat engine — the console's readers", () => {
